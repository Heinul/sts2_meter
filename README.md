...
[Steam 창작마당 페이지](https://steamcommunity.com/sharedfiles/filedetails/?id=3747736591)에서 **구독**하면 자동으로 설치/업데이트됩니다.

#### 방법 2: 수동 설치

1. [Releases](https://github.com/Heinul/sts2_meter/releases)에서 최신 `DamageMeterMod.dll`과 `DamageMeterMod.json`을 다운로드합니다.
...
|----|------|
| **F7** | 데미지 미터 표시/숨기기 |
| **F6** | 패널 위치/크기 초기화 (화면 밖으로 나간 경우 복구) |
...
- Doom damage tracking with proportional attribution
...
- Energy cost displayed per card
- Card exhaust (Ethereal distinction) / discard / forge / doom kill tracking
...
Subscribe on the [Steam Workshop page](https://steamcommunity.com/sharedfiles/filedetails/?id=3747736591) for automatic install and updates.

#### Option 2: Manual

1. Download the latest `DamageMeterMod.dll` and `DamageMeterMod.json` from [Releases](https://github.com/Heinul/sts2_meter/releases)
...
| **F6** | Reset panel position/size (recover if off-screen) |
